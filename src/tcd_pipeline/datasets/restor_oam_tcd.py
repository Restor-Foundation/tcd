...
class RestorOAMTCD(NonGeoDataset):
    """

    Dataset format:

    * images are three-channel geotiffs in uint8 format
    * labels are in MS-COCO format with instance segmentation labels
    ...
    * https://doi.org/10.34911/rdnt.9r6ekg
    ...
    dataset_id = "restor_oam_tcd"
    directories = ["restor_oam_tcd_root"]
